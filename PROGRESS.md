...
- ⚠️ **تعارضات تحتاج قرار المالك**: (١) السعر في اللاندنج 99,000 (شارة «أول 100 مطعم: 79,000» حُذفت بقرار المالك 2026-09-18) بينما `COMPANY-CONTEXT.md` §2 و`lib/subscription.ts` يقولان 199,000 لباقة Menu · (٢) رابط «دخول أصحاب المطاعم» اختفى من الجذر — الدخول عبر `/admin` مباشرة · (٣) `COMPANY-CONTEXT.md` §3 كان يفترض الموقع التسويقي في مستودع منفصل، والآن يعيش هنا على الجذر
