...
- **المرحلة الحالية:** 🟢 إعادة تصميم الموقع بنظام تصميم ميسا — كل المراحل (٠–٥) مكتملة
- **آخر إنجاز:** إعادة جلد الموقع كاملاً بلوحة ميسا الدافئة (نبيذي/ذهبي/كريمي + Tajawal) — الزبون + الإدارة + المالك + الهبوط
