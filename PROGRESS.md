...
- ⚠️ **تعارضات تحتاج قرار المالك**: (١) السعر في اللاندنج 99,000 (و79,000 لأول ١٠٠ مطعم) بينما `COMPANY-CONTEXT.md` §2 و`lib/subscription.ts` يقولان 199,000 لباقة Menu · (٢) رابط «دخول أصحاب المطاعم» اختفى من الجذر — الدخول عبر `/admin` مباشرة · (٣) `COMPANY-CONTEXT.md` §3 كان يفترض الموقع التسويقي في مستودع منفصل، والآن يعيش هنا على الجذر
