...
- **آخر إنجاز:** بدء إعادة تصميم الموقع بنظام تصميم ميسا — المرحلة ٠ (الأساس: tokens + خطوط) مكتملة
- **التالي:** إعادة التصميم — المرحلة ١ (المكوّنات الأوّلية). الخطة في `.scratch/design-redesign/plan.md`
- **عقبات/قرارات معلّقة:**
  - اسم الدومين (PRD §٩)
