...
const STRINGS = {
  ar: {
    ...
    rate_clean: 'النظافة والتعقيم',
    rate_overall: 'كيف كانت تجربتك العامة؟',
    rate_contact: 'اتصال',
    rate_name: 'الاسم',
    rate_phone: 'رقم الهاتف',
    rate_comment: 'أي تعليق إضافي:',
    rate_comment_ph: 'انقر هنا للتعليق',
    rate_submit: 'إرسال',
    rate_required: 'اختر تقييماً في كل الأقسام أولاً.',
    rate_failed: 'تعذّر الإرسال، حاول مرة أخرى.',
    rate_thanks: 'شكراً لك! وصلنا تقييمك.',
  },
  en: {
    ...
    rate_clean: 'Cleanliness & hygiene',
    rate_overall: 'How was your overall experience?',
    rate_contact: 'Contact',
    rate_name: 'Name',
    rate_phone: 'Phone number',
    rate_comment: 'Any additional comment:',
    rate_comment_ph: 'Tap here to comment',
    rate_submit: 'Send',
    rate_required: 'Please pick a rating in every section first.',
    rate_failed: 'Could not send, please try again.',
    rate_thanks: 'Thank you! We received your rating.',
  },
  ku: {
    ...
    quantity: 'بڕ',
    all_items: 'هەموو',
    rate_button: 'هەڵسەنگاندن',
    rate_title: 'هەڵسەنگاندن',
    rate_staff: 'هەڵسەنگاندنی کارمەندان',
    rate_service: 'هەڵسەنگاندنی خزمەتگوزاری',
    rate_clean: 'پاکی و خاوێنی',
    rate_overall: 'ئەزموونی گشتیت چۆن بوو؟',
    rate_contact: 'پەیوەندی',
    rate_name: 'ناو',
    rate_phone: 'ژمارەی مۆبایل',
    rate_comment: 'هەر تێبینییەکی زیادە:',
    rate_comment_ph: 'لێرە بنووسە',
    rate_submit: 'ناردن',
    rate_required: 'تکایە لە هەموو بەشەکان هەڵسەنگاندنێک هەڵبژێرە.',
    rate_failed: 'ناردن سەرکەوتوو نەبوو، دووبارە هەوڵ بدەوە.',
    rate_thanks: 'سوپاس! هەڵسەنگاندنەکەت گەیشت.',
  },
} as const;
